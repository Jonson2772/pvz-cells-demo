...
- в текущей пилотной выборке наблюдаемое время приёмки сократилось с 38,92 до 30,60 минуты на 100 отправлений, или на 21,4%; устойчивость эффекта требует дальнейшей проверки.
...
2. Запустить мультяшное сканирование этикетки на посылке и увидеть распознанную ячейку.
